  ...
  return (
    <header className="px-3 sm:px-6 pt-3 pb-2 select-none">
      <div className="max-w-7xl mx-auto rounded-3xl border px-4 sm:px-6 py-3 transition-colors duration-200 bg-[#0c1017] border-zinc-800 text-white shadow-xl shadow-black/20">
        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 sm:gap-4 relative w-full">
          ...
          <div className="flex items-center justify-start gap-2 min-w-0">
            ...
            {showBackButton && (
              <button
                ...
                className="w-9 h-9 rounded-2xl border border-zinc-800 bg-zinc-900 hover:bg-zinc-800 text-white flex items-center justify-center transition cursor-pointer shadow-sm shrink-0"
            ...
            <button
              type="button"
              onClick={onOpenChat}
              className="px-3 sm:px-3.5 py-1.5 rounded-2xl border border-zinc-800 bg-zinc-900/90 hover:bg-zinc-800 text-white text-xs font-bold flex items-center gap-2 transition cursor-pointer shadow-sm hover:border-emerald-500/50 hover:shadow-emerald-500/10 group shrink-0"
          ...
          <div className="flex flex-col items-center justify-center space-y-1.5 py-0.5 justify-self-center text-center">
            <STFLogo
              isWhite={true}
              className="h-11 sm:h-14 md:h-16 w-48 sm:w-72 md:w-80 transition-all duration-300"
            />
            ...
            {currentUser && (
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 px-3.5 py-1 rounded-full border border-emerald-500/50 bg-zinc-900/90 text-zinc-200 text-[10.5px] font-medium font-mono hover:scale-105 active:scale-95 transition-all duration-150 cursor-pointer shadow-sm hover:shadow-emerald-500/20 group ring-1 ring-emerald-500/30"
          ...
          <div className="flex items-center justify-end gap-1.5 sm:gap-2 min-w-0">
            ...
            <button
              ...
              disabled={isSyncing}
              className="px-2.5 sm:px-3 py-1.5 rounded-2xl border border-zinc-800 bg-zinc-900/90 hover:bg-zinc-800 text-white text-[11px] font-bold flex items-center gap-1.5 transition cursor-pointer shadow-sm hover:border-emerald-500/50 group disabled:opacity-75 shrink-0"
            ...
            <button
              ...
              className="px-2.5 sm:px-3 py-1.5 rounded-2xl border border-zinc-800 bg-zinc-900 hover:bg-zinc-800 text-white text-[11px] font-bold flex items-center gap-1.5 transition cursor-pointer shadow-sm shrink-0"
              title={isDarkMode ? 'Cambiar a Modo Claro' : 'Cambiar a Modo Oscuro'}
            >
              {isDarkMode ? (
                <>
                  <Sun className="w-3.5 h-3.5 text-amber-400" />
                  <span className="tracking-wide text-[10px] hidden xs:inline">CLARO</span>
                </>
              ) : (
                <>
                  <Moon className="w-3.5 h-3.5 text-indigo-400" />
                  <span className="tracking-wide text-[10px] hidden xs:inline">OSCURO</span>
                </>
              )}
            </button>
            ...
            <button
              type="button"
              onClick={onLogout}
              className="px-3 sm:px-3.5 py-1.5 rounded-2xl bg-white text-zinc-950 hover:bg-zinc-200 text-[11px] font-black uppercase tracking-wider flex items-center gap-1.5 transition cursor-pointer shadow-sm shrink-0"
              title="Cerrar sesión"
            >
