...
import { UsuarioSTF, canViewEvaluadoSection } from '../../services/authService';
...
export const KpiCards: React.FC<KpiCardsProps> = ({ metrics, currentUser, onSelectArea }) => {
  const showEvaluado = canViewEvaluadoSection(currentUser);

  return (
    <div className={`grid grid-cols-2 sm:grid-cols-4 ${showEvaluado ? 'lg:grid-cols-8' : 'lg:grid-cols-7'} gap-2 sm:gap-3`}>
